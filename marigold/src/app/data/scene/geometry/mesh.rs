...
use mesh_interface::{MeshRecord, Scene, UploadedMesh};
...
//     info: MeshRecord,
//     serialized_record: SerializedMesh,
// }

// #[derive(Resource, Deref, DerefMut)]
// pub struct LoadedMeshes {
//     pub records: Vec<LoadedMesh>,
// }
...
//     mut meshes: ResMut<UploadedMeshes>,
...
//         let first_scene = &scenes[0];

//         log::info!("loading the first available scene, '{}'", first_scene.name);

//         for instance in &first_scene.instances {
//             let record = &mesh_records[instance.mesh_index];
